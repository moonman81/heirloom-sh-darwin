...
Chain of custody for the `sh` package (Bourne shell) as vendored by
this Darwin port.
...
- **Upstream tarballs**: `/opt/heirloom/src/original/heirloom-sh-*/`
...
- This port: `moonman81 (2026). heirloom-sh-darwin.
