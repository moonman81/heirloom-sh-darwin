...
(arm64) port** of Gunnar Ritter's Heirloom Bourne shell. It is
...
The commit at commit 1 (`22944b2`) is a **byte-exact
reproduction** of the upstream **heirloom-sh-050706** tarball. Every
