...
This directory is part of `moonman81/heirloom-sh-darwin`, the
Darwin port of the sh package from Gunnar Ritter's Heirloom
...
- **Subdirs**: heirloom-non-authoritative-downstream-port, heirloom-per-file-license-patchwork, heirloom-port-alm-lifecycle, traditional-bourne-shell-preservation
